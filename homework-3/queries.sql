...
select distinct company_name from customers c
...
select distinct product_name from (select product_name, quantity from products
									join order_details USING (product_id)) AS a
									where a.quantity = 10
